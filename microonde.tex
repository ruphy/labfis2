...
odrfit, chi, chiprob = fit_chiquad(incidente, rifratto, func, init_guess=[1.,0.], ysigma=errang)
...
\begin{center}
\sagestr{stampa_dati(dati, r'$I$ (Volt) & $\gamma$ (rad) & $I_{teorico}$ (Volt) & $\sigma_{I_{teo}}$ ' )}
\end{center}
