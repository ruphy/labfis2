...
Ricaviamo la lunghezza d'onda posizionando emettitore e ricevitore ai capi del metro, e muovendo il ricevitore lungo questo. Si osserva infatti il
passaggio alterno per massimi e minimi di intensità, e partendo da un massimo di intensità e spostandosi di n minimi fino ad
un altro massimo usiamo la formula:
\begin{equation}
d = n\frac{\lambda}{2}
\label{d}
\end{equation}
...
\begin{center}
\sagestr{stampa_dati(dati, r'$d$ (cm) & $n$ (rad) & $\lambda$ ' )}
\end{center}
