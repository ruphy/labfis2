...
Questo comporta una certa difficoltà nell'analisi degli errori, in quanto è impossibile conoscere l'incertezza della misura. Abbiamo ritenuto di stimare gli errori mantendendo costante l'errore relativo.
