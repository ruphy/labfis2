...
$\chi^2 = \sage{round(chi,3)}$ con d.o.f = $\sage{len(tempo)-2}$\\
Il p-value associato è $0.04$, che è minore della soglia di accettabilità fissata a $0.05$. !! %Che si fa?
...
%Cosa ne dite? Scriviamo qualcosa? Tutta la nostra analisi degli errori è davvero poco lecita..ma è l'unica possibile. A meno che al posto di calcolare il chi-quadro, ci calcoliamo l'incertezza a posteriori.
...
Questo comporta una certa difficoltà nell'analisi degli errori, in quanto è impossibile conoscere l'incertezza della misura. Abbiamo deciso di stimare gli errori mantendendo costante l'errore relativo.
