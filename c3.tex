...
Per questa formula di propagazione, l'errore risulta irrilevante. %Nei calcoli l'ho posto a 0.01 volt che scriviamo?'
...
\subsubsection{Nota sulle differenze dei valori}
Non ci è chiara la ragione per la quale le C differe
