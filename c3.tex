...
Da questo fit, otteniamo una $L=0.0017 H$, e un $\chi^2 = 8.48 $, considerando una $\sigma_y = 2 \pi \nu \sigma_{t}$, dove  per $\sigma_t = \pm 2 \mu s$. L'incertezza sulla frequenza è considerato trascurabile, e per questo motivo abbiamo propagato l'incertezza solo su $\sigma_t$. Avendo 9 gradi di libertà, otteniamo un $\tilde{\chi}^2 = 0.94$.
